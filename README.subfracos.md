...
## Current Status: Level 1 (Configuration Layer)
...
1. Set your GitHub token (for MCP):
   ```bash
...
3. The Docker MCP Gateway will be preconfigured and ready
...
- ~7-11 hours of work, zero maintenance burden

### 📋 Level 2: Extension-First (PLANNED)
Build Zed extensions for Subfracture-specific workflows:
- **Danni Integration** - Context panel showing Danni's memory/state
