...
# https://github.com/domocarroll/subfracOS/issues/1852
...
subfrac-pkg-add xdg-terminal-exec
...
if command -v alacritty > /dev/null 2>&1; then
  cp "$SUBFRAC_PATH/applications/Alacritty.desktop" ~/.local/share/applications/
fi
