...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "subfracOS Dev Instance Running",
        ReleaseChannel::Nightly => "subfracOS Nightly Instance Running",
        ReleaseChannel::Preview => "subfracOS Preview Instance Running",
        ReleaseChannel::Stable => "subfracOS Stable Instance Running",
    }
}
